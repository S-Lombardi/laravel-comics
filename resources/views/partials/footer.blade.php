        ...
        <div class="row">
            ...
            <div class="d-flex flex-column" style="background-image:url({{Vite::asset('/resources/img/footer-bg.jpg')}})">
                <div class="col-12 d-flex justify-content-between " >
                    ...
                    <div>
                        <img class="w-75" src="{{Vite::asset('./resources/img/dc-logo-bg.png')}}" alt="">
                    </div>
                </div>
                <div class= "ms-5">
                    <span class="text-secondary">
                        All Site Content TM and © 2020 DC Entertainment, unless otherwise <a href="/" class="text-decoration-none">noted here</a>. All rights reserved. <br> <a href="/" class="text-decoration-none">Cookies Settings</a>
                    </span>
                </div>
            </div>
